...
export function SkillCard({ name, level, icon, delay = 0 }: SkillCardProps) {
  ...
  return (
    <motion.div
      ref={ref}
      className="group relative p-6 rounded-2xl bg-white dark:bg-gray-800 shadow-md hover:shadow-xl transition-all border border-gray-100 dark:border-gray-700"
    ...
    >
      {/* Icon */}
      <div className="w-12 h-12 mb-4 rounded-xl bg-gray-100 dark:bg-gray-700 flex items-center justify-center group-hover:scale-110 transition-transform">
