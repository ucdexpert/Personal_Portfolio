            ...
            {skillCategories.map((category, categoryIndex) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <div className="w-10 h-10 rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-500 dark:to-purple-500 flex items-center justify-center">
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {[
                ...
                <motion.span
                  key={skill}
                  className="px-4 py-2 rounded-full bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 text-sm font-medium shadow-md border border-gray-200 dark:border-gray-700"
                  initial={{ opacity: 0, scale: 0.8 }}
                  animate={isInView ? { opacity: 1, scale: 1 } : {}}
